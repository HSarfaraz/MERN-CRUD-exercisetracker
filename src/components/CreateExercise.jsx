    ...
    return (
      <div className="container" md={12} sm={12}>
        ...
        <div className="row h-100 justify-content-center align-items-center">
          ...
          <h3 className="font-weight-bold text-uppercase col-sm-12 text-center">Create New Exercise Log</h3>
          ...
          <form onSubmit={this.onSubmit} className="col-sm-4">
            ...
            <div className="form-group">
              ...
              {/* ref="userInput" */}
              {/* ref={this.callRef}  */}
              <select  ref={this.callRef}  className="form-control" value={this.state.username} onChange={this.onChangeUsername} required>
                {
